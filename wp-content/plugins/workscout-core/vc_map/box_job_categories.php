...
function ws_box_job_categories_integrateWithVC() {
  ...
  vc_map( array(
    ...
    "params" => array(
      ...
      // array(
      //   'type' => 'checkbox',
      //   'heading' => esc_html__( 'Show Background Image on Hover', 'workscout_core' ),
      //   'param_name' => 'background_on_hover',
      //   'description' => esc_html__( 'This option will use image added in category edit screen in option "Background image for category header".', 'workscout_core' ),

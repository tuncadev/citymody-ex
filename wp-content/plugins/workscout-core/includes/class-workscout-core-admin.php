        ...
        $settings['registration'] = array(
            ...
            'fields'                => array(
                ...
                array(
                    ...
                    'label'         => __('Employer redirect after registration to page', 'listeo_core'),
                ...
                array(
                    ...
                    'options'       => workscout_core_get_pages_options(),
                    'label'         => __('Employer redirect after login to page', 'listeo_core'),
                    //'description'   => __( 'Main Dashboard page for user', 'listeo_core' ),
                    'type'          => 'select',
                ),
                array(
                    ...
                    'options'       => workscout_core_get_pages_options(),
                    'label'         => __('Candidate redirect after registration to page', 'listeo_core'),
                    //'description'   => __( 'Main Dashboard page for user', 'listeo_core' ),
                    'type'          => 'select',
                ),
                array(
                    ...
                    'options'       => workscout_core_get_pages_options(),
                    'label'         => __('Candidate redirect after login to page', 'listeo_core'),
                    //'description'   => __( 'Main Dashboard page for user', 'listeo_core' ),
                    'type'          => 'select',
                ),
            )

			...
			<ul id="workscout-activities-list">
				...
				if($items) :
					...
					switch ($item->action) {
							...
							case 'resume_updated':
								echo $start.'
									<i class="list-box-icon fa fa-floppy-o"></i> '.esc_html__('Resume','workscout_core').' <strong><a href="'.esc_url($post_url).'">'.$post_title.'</a></strong> '.esc_html__('was updated','workscout_core').'.
								'.$end;
								break;
							case 'resume_created':
								echo $start.'
									<i class="list-box-icon fa fa-file-text-o"></i> '.esc_html__('Resume','workscout_core').' <strong><a href="'.esc_url($post_url).'">'.$post_title.'</a></strong> '.esc_html__('was created.','workscout_core').$end;
								break;
							case 'resume_approved':
								echo $start.'
									<i class="list-box-icon fa fa-check"></i>'.esc_html__('Your Resume','workscout_core').' <strong><a href="'.esc_url($post_url).'">'.$post_title.'</a></strong> '.esc_html__('was approved','workscout_core').'
								'.$end;
								break;
							case 'resume_trashed':
								echo $start.'
									<i class="list-box-icon fa fa-trash"></i> '.esc_html__('Resume','workscout_core').' <strong><a href="'.esc_url($post_url).'">'.$post_title.'</a></strong> '.esc_html__('was removed','workscout_core').'
								'.$end;
								break;

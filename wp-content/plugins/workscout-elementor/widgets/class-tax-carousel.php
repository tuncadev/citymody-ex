...
class TaxonomyCarousel extends Widget_Base {
	...
	public function get_name() {
		return 'workscout-taxonomy-carousel';
	}
	...
	public function get_title() {
		return __( 'Taxonomy Carousel', 'workscout_elementor' );
	}
					...
					<div class="category-box-container">
						<a href="<?php echo esc_url(get_term_link( $term )); ?>" class="category-box" data-background-image="<?php echo $cover[0];  ?>">
							<div class="category-box-content">
								...
								<?php if($settings['show_counter'] == 'yes'): ?><span><?php $count = workscout_get_term_post_count( $settings['taxonomy'],$term->term_id);  echo $count ?> <?php esc_html_e('listings','workscout_elementor'); ?></span><?php endif; ?>
							</div>
							<span class="category-box-btn"><?php esc_html_e('Browse','workscout_elementor') ?></span>
						</a>
					</div>
				</div>

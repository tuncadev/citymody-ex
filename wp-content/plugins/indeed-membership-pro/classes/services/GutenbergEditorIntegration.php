...
class GutenbergEditorIntegration
{
    ...
    public function assets()
    {
        ...
        wp_register_script( 'ihc-gutenberg-locker-integration', IHC_URL . 'assets/js/gutenberg_locker_integration.js', array('wp-blocks', 'wp-block-editor', 'wp-i18n', 'wp-element', 'wp-editor', 'jquery' ), 10.1 );
        ...
        wp_enqueue_script( 'ihc-gutenberg-integration', IHC_URL . 'assets/js/gutenberg_integration.js', array('wp-blocks', 'wp-block-editor', 'wp-i18n', 'wp-element', 'wp-editor', 'jquery' ), 10.1 );

...
class Braintree extends \Indeed\Ihc\Gateways\PaymentAbstract
{
    ...
    {
        $data['status'] = 1;
        $this->inputCardData['ihc_braintree_cardholderName'] = isset( $input['ihc_braintree_cardholderName'] ) ? esc_sql( $input['ihc_braintree_cardholderName'] ) : '';
        ...
        $this->inputCardData['ihc_braintree_cvv'] = isset( $input['ihc_braintree_cvv'] ) ? esc_sql( $input['ihc_braintree_cvv'] ) : '';
        $this->inputCardData['ihc_braintree_card_number'] = isset( $input['ihc_braintree_card_number'] ) ? esc_sql( $input['ihc_braintree_card_number'] ) : '';
        $this->inputCardData['ihc_braintree_card_expire_month'] = isset( $input['ihc_braintree_card_expire_month'] ) ? esc_sql( $input['ihc_braintree_card_expire_month'] ) : '';
        $this->inputCardData['ihc_braintree_card_expire_year'] = isset( $input['ihc_braintree_card_expire_year'] ) ? esc_sql( $input['ihc_braintree_card_expire_year'] ) : '';

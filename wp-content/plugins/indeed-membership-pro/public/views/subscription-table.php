...
$payments_available = ihc_get_active_payments_services();
      ...
      foreach ( $data['subscriptions'] as $subscriptionData ){
        ...
        <tr>
          ...
          <td  class="ihc-level-name-wrapp ihc-content-left"><span class="ihc-level-name">
            <span class="ihc-level-status-set-<?php echo $subscriptionStatus['status_as_string'];?>"><?php echo $membershipData['label'];?></span></span>
          </td>
          ...
          <?php if ( !empty( $data['settings']['ihc_show_expires_on_column'] ) ):?>
              ...
              <?php else :?>
                  <?php echo $subscriptionData['expire_time'];?>
              <?php endif;?>
              </td>
          <?php endif;?>
          ...
          <?php if ( !empty( $data['settings']['ihc_show_status_column'] ) ):?>
              <td class="ihc_account_level_status">
                 <span class="ihc-level-status-set-<?php echo $subscriptionStatus['status_as_string'];?>" ><?php echo $subscriptionStatus['label'];?></span>
              </td>
          <?php endif;?>
          ...
          <div class="ihc-subscription-table-actions ihc-content-right" id="<?php echo $hidden_div;?>">
            ...
            <!-- Finish Payment Button -->
                <?php if ( \Indeed\Ihc\SubscriptionActionsButtons::showFinishPayment( $subscriptionData['user_id'], $subscriptionData['level_id'], $subscriptionData['id'] ) ):?>
                    <div class="iump-subscription-table-button">
                        <?php
                            $paymentService = $orderMeta->get( $orderId, 'ihc_payment_type' );
                            if ( $checkoutPage !== '' && $checkoutPage !== false && $paymentService !== false
                                  && $paymentService === 'stripe_connect' && ihc_check_payment_available( 'stripe_connect' ) ){
                                ...
                                ?>
                                <span class="iump-renew-subscription-button"><a href="<?php echo $finishPaymentLink;?>" ><?php
                                    esc_html_e( 'Finish Payment', 'ihc');
                                ?></a></span>
                            <?php
                          } else {
                        ?>
                          <span class="ihc-js-finish-payment-bttn" data-lid="<?php echo $subscriptionData['level_id'];?>"
                                data-level_name="<?php echo $membershipData['label'];?>"
                                data-level_amount="<?php echo $membershipData['price'];?>"
                                data-oid="<?php echo $orderId;?>"
                                 ><?php
                              esc_html_e( 'Finish Payment', 'ihc' );
                          ?></span>
                        <?php }?>
            ...
            <!-- Renew Button -->
                <?php if ( \Indeed\Ihc\SubscriptionActionsButtons::showRenew( $subscriptionData['user_id'], $subscriptionData['level_id'], $subscriptionData['id'] )
                    ...
                    $renewLink = add_query_arg( $urlParams, $checkoutPage );?>
                        ...
                        <span class="iump-renew-subscription-button iump-renew-<?php echo $subscriptionData['level_id'];?>-subscription"
                        ><a href="<?php echo $renewLink;?>" ><?php esc_html_e( 'Renew', 'ihc');?></a></span>
                    </div>
                <?php endif;?>
            ...
            <!-- Pause Button -->
                <?php if ( \Indeed\Ihc\SubscriptionActionsButtons::showPause( $subscriptionData['user_id'], $subscriptionData['level_id'], $subscriptionData['id'] ) ):?>
                    ...
                    <div class="iump-subscription-table-button">
                        <span class="ihc-js-pause-subscription-bttn iump-pause-<?php echo $subscriptionData['level_id'];?>-subscription" data-subscription_id="<?php echo $subscriptionData['id'];?>" data-lid="<?php echo $subscriptionData['level_id'];?>"><?php
            ...
            <?php if ( \Indeed\Ihc\SubscriptionActionsButtons::showResume( $subscriptionData['user_id'], $subscriptionData['level_id'], $subscriptionData['id'] ) ):?>
                ...
                <div class="iump-subscription-table-button">
                    <span class="ihc-js-resume-subscription-bttn iump-resume-<?php echo $subscriptionData['level_id'];?>-subscription" data-subscription_id="<?php echo $subscriptionData['id'];?>" data-lid="<?php echo $subscriptionData['level_id'];?>"><?php
            ...
            <?php endif;?>
              ...
              <?php if ( \Indeed\Ihc\SubscriptionActionsButtons::showCancel( $subscriptionData['user_id'], $subscriptionData['level_id'], $subscriptionData['id'] ) ):?>
                  <div class="iump-subscription-table-button">
                      <span class="iump-cancel-subscription-button iump-cancel-<?php echo $subscriptionData['level_id'];?>-subscription" data-lid="<?php
                          echo $subscriptionData['level_id'];?>"><?php esc_html_e( 'Cancel', 'ihc' );
                      ?></span>
                  </div>
              <?php endif;?>
              ...
              <!-- Remove Button -->
                  <?php if ( \Indeed\Ihc\SubscriptionActionsButtons::showRemove( $subscriptionData['user_id'], $subscriptionData['level_id'], $subscriptionData['id'] ) ):?>
                      <div class="iump-subscription-table-button">
                          <span class="iump-delete-subscription-button iump-delete-<?php echo $subscriptionData['level_id'];?>-subscription" data-lid="<?php echo $subscriptionData['level_id'];?>"><?php
              ...
              <?php if ( \Indeed\Ihc\SubscriptionActionsButtons::showStripeChangeCard( $subscriptionData['user_id'], $subscriptionData['level_id'], $subscriptionData['id'] ) ):?>
                  <div class="iump-subscription-table-button">
                      <span class="ihc-js-stripe-connect-change-card iump-change-card-<?php echo $subscriptionData['level_id'];?>-subscription" data-subscription_id="<?php echo $subscriptionData['id'];?>" data-uid="<?php echo $subscriptionData['user_id'];?>"><?php
              ...
              <?php if ( \Indeed\Ihc\SubscriptionActionsButtons::showChangePlanBttn( $subscriptionData['user_id'], $subscriptionData['level_id'], $subscriptionData['id'] ) ) :?>
                <div class="iump-subscription-table-button">
                    ...
                    ?>
                    <a href="<?php echo $subscriptionPage;?>" class="" ><?php
    ...
    <?php do_action( 'ump_public_account_page_subscription_table-row', $subscriptionData['user_id'] );?>
      ...
      $allPaymentsAvailable = ihc_get_active_payments_services();
      if ( $defaultPayment=='stripe' || isset( $allPaymentsAvailable['stripe'] ) ){

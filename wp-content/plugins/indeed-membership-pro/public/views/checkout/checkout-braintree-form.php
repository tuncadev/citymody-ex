<?php wp_register_script( 'ihc-braintree', IHC_URL . 'assets/js/braintree.js', [], false );?>
<?php
global $wp_version;
...
<div class="ihc-braintree-form-wrapper">
 ...
 <div class="ihc-braintree-form-card-name-wrap">
   <input type="text" class="ihc-braintree-input" value="<?php echo $data['fields']['ihc_braintree_cardholderName']['value'];?>" name="ihc_braintree_cardholderName" placeholder="<?php esc_html_e('Name on the Card *', 'ihc');?>"/>
 </div>
 <div class="ihc-braintree-form-card-number-wrap">
   ...
   <div class="ihc-braintree-form-card-element">
     <input type="number" class="ihc-braintree-input" value="<?php echo $data['fields']['ihc_braintree_card_number']['value'];?>" name="ihc_braintree_card_number" placeholder="1234 1234 1234 1234"/>
   </div>
 </div>
 <div class="ihc-braintree-form-details-wrap">
   <div class="ihc-braintree-form-details-exp-wrap">
     <div class="ihc-braintree-form-details-exp-label"><?php esc_html_e('Expiration', 'ihc');?> <span class="ihc-required-sign">*</span></div>
     <div class="ihc-braintree-form-details-elements">
       <input type="number" class="ihc-braintree-input" value="<?php echo $data['fields']['ihc_braintree_card_expire_month']['value'];?>" name="ihc_braintree_card_expire_month" placeholder="MM" min="1" max="12"/>
       <span class="ihc-braintree-form-details-exp-split">/</span>
       <input type="number" class="ihc-braintree-input" value="<?php echo $data['fields']['ihc_braintree_card_expire_year']['value'];?>" name="ihc_braintree_card_expire_year" placeholder="YY" min="<?php echo $data['fields']['ihc_braintree_card_expire_year']['min'];?>"
     max="<?php echo $data['fields']['ihc_braintree_card_expire_year']['max'];?>"/>
   </div>
   </div>
   <div class="ihc-braintree-form-details-cvv-wrap">
     ...
     <input type="number" class="ihc-braintree-input" value="<?php echo $data['fields']['ihc_braintree_cvv']['value'];?>" name="ihc_braintree_cvv" placeholder="123"/>
   </div>
 </div>

          ...
          if(isset($data['preparePaymentData']['first_amount']) && ($data['preparePaymentData']['first_amount'] != '' || $data['preparePaymentData']['first_amount'] === 0)){?>
            ...
            <table class="ihc-product-details-table">
              <tr class="ihc-product-details-table-name-row">
                <td>
                  ...
                  <div class="ihc-product-description"><?php echo $data['levelData']['short_description'];?></div>
                </td>
                <td></td>
              </tr>
              ...
              <tr>
                <td>
                  <div class="ihc-product-trial-fee-label"><?php echo $data['messages']['ihc_checkout_price_initial'];?></div>
                  ...
                  <div class="ihc-product-price" id="ihc-initial-payment-price">
                    <span id="ihc-initial-payment-price">
                      <?php if($data['preparePaymentData']['initial_first_amount'] > 0){
                        echo ihc_format_price_and_currency( $data['currency'], $data['preparePaymentData']['initial_first_amount']);
                      }else{
                        echo $data['messages']['ihc_checkout_price_free'];
                      }
                        ?>
                    </span>
              ...
              <tr id="ihc-initial-payment-discount" <?php echo (isset($data['couponData']['details']) && is_array($data['couponData']['details']) && count($data['couponData']['details']) > 0 && isset($data['preparePaymentData']['first_discount']) && $data['preparePaymentData']['first_discount'] > 0) ? '' : 'class="ihc-display-none"'; ?>>
                <td><div class="ihc-product-fee-label-extra"><?php echo $data['messages']['ihc_checkout_price_discount'];?> (<span id="ihc-main-payment-discount-value">
              ...
              <tr id="ihc-initial-payment-taxes">
                <td colspan="2">
                    <table class="ihc-product-extra-details-table">
                      ...
                      <tr>
                        <td><div class="ihc-product-fee-label-extra"><?php echo $item['label'].' ('.$item['percentage'].'%)'; ?></div></td>
                        <td><div class="ihc-product-price-extra"><?php echo $item['print_value']; ?></div></td>
                      </tr>
                    <?php } ?>
                    </table>
                </td>
            ...
            <?php } ?>
              ...
              <tr class="ihc-then-payment-wrapper">
                <td>
                  <div class="ihc-product-main-fee-label"><?php echo $data['messages']['ihc_checkout_price_then'];?></div>
                  <div class="ihc-price-description"></div>
                </td>
                <td>

...
<div class="ihc-checkout-page-box-wrapper ihc-subtotal-wrapper">
  <div class="ihc-checkout-page-box-title"><?php echo $data['messages']['ihc_checkout_subtotal_title'];?></div>
  <?php
    ...
    case 'regular_period':
        if(isset($data['preparePaymentData']['first_amount']) && ($data['preparePaymentData']['first_amount'] != '' || $data['preparePaymentData']['first_amount'] === 0)){?>
          ...
          <table  class="ihc-product-details-table ihc-subtotal-table">
            <tr>
              <td><div class="ihc-product-trial-fee-label"><?php echo $data['messages']['ihc_checkout_price_initial'];?></div></td>
              <td>
            ...
            <tr>
              <td><div class="ihc-product-main-fee-label"><?php echo $data['messages']['ihc_checkout_price_then'];?></div>
              </td>
              <td>
                <div class="ihc-product-price">
       ...
       <?php }else{ ?>
          ...
          <table  class="ihc-product-details-table ihc-subtotal-table">
            <tr>
              <td><div class="ihc-product-main-fee-label"><?php echo $data['messages']['ihc_checkout_price_fee'];?></div>
              </td>
              <td>
                <div class="ihc-product-price">
                  <span id="ihc-subtotal-product-price"><?php echo ihc_format_price_and_currency( $data['currency'], $data['preparePaymentData']['amount']);?></span>

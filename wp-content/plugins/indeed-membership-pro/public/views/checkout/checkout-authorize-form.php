<?php wp_register_script( 'ihc-authorize', IHC_URL . 'assets/js/authorize.js', [], false );?>
<?php
global $wp_version;
...
<div class="ihc-authorize-form-wrapper">
 ...
 <div class="ihc-authorize-form-card-name-wrap">
   <input type="text" class="ihc-authorize-input" value="<?php echo $data['fields']['ihcpay_cardholderName']['value'];?>" name="ihcpay_cardholderName" placeholder="<?php esc_html_e('Name on the Card *', 'ihc');?>"/>
 </div>
 ...
 <div class="ihc-authorize-form-details-wrap">
   <div class="ihc-authorize-form-details-card-number-wrap">
     ...
     <input type="number" class="ihc-authorize-input" value="<?php echo $data['fields']['ihcpay_card_number']['value'];?>" name="ihcpay_card_number" placeholder="1234 1234 1234 1234"/>
   ...
   <div class="ihc-authorize-form-details-exp-wrap">
     ...
     <input type="number" class="ihc-authorize-input" value="<?php echo $data['fields']['ihcpay_card_expire']['value'];?>" name="ihcpay_card_expire" placeholder="MMYY"/>
   </div>
 </div>

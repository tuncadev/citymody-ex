							...
							<div>
								...
								<div  class="ihc-padding ihc-text-aling-right">
									...
									<?php
										...
										?>
										<select onChange="ihcWriteTagValue(this, '#ihc_mb_who_hidden-<?php echo $item_id;?>', '#ihc_tags_field-<?php echo $item_id;?>', '<?php echo $item_id;?>_ihc_select_tag_' );">
					                    ...
					                    if($item->ihc_mb_who_menu_type){
					                        ...
					                        foreach($values as $value){ ?>
					                        	<div id="<?php echo $item_id;?>_ihc_select_tag_<?php echo $value;?>" class="ihc-tag-item">
					                        		...
					                        		<div class="ihc-remove-tag" onclick="ihcremoveTag('<?php echo $value;?>', '#<?php echo $item_id;?>_ihc_select_tag_', '#ihc_mb_who_hidden-<?php echo $item_id;?>');" title="<?php esc_html_e('Removing tag', 'ihc');?>">x</div>
					                        	</div>
					                            <?php
					                        }//end of foreach ?>
...
function ihc_wp_menu_custom_settings_do_update( $menu_id, $menu_db_id, $args )
{
	if ( isset($_POST['ihc_mb_who_menu_type-'.$menu_db_id]) && isset($_POST['ihc_menu_mb_type-'.$menu_db_id]) ) {
		update_post_meta( $menu_db_id, 'ihc_mb_who_menu_type', $_POST['ihc_mb_who_menu_type-'.$menu_db_id]);
		update_post_meta( $menu_db_id, 'ihc_menu_mb_type', $_POST['ihc_menu_mb_type-'.$menu_db_id]);
	}
}
endif;

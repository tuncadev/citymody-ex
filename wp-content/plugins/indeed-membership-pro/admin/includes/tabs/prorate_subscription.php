...
// save/update group
if ( isset( $_POST['ihc_save_prorate'] ) ){
		$memberships = isset( $_POST['memberships'] ) ? $_POST['memberships'] : [];
		...
		if ( isset( $_POST['id'] ) ){
				...
				foreach ( $memberships as $key => $levelId ){
						...
						if ( $groupId !== false && (int)$groupId !== (int)$_POST['id'] ){
								unset( $memberships[$key] );
						}
				}
	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<div class="iump-form-line">
				<div class="row">
					<div class="col-xs-12">
						<p><strong><?php esc_html_e('Important: Prorating Process is cover only by Stripe Connect Payment service. You can setup and activate this Payment Service ', 'ihc');?><a target="_blank" href="<?php echo $url.'&tab=payment_settings&subtab=stripe_connect';?>"><?php esc_html_e('here', 'ihc');?></a></strong></p>
					</div>
				</div>
			</div>
      ...
      <div class="iump-form-line">
			...
			<div class="iump-form-line">
				...
				<label class="iump_label_shiwtch ihc-switch-button-margin">
					...
					<input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_prorate_show_details_on_checkout');" <?php echo $checked;?> />
					<div class="switch ihc-display-inline"></div>
				</label>
				<input type="hidden" name="ihc_prorate_show_details_on_checkout" value="<?php echo $data['metas']['ihc_prorate_show_details_on_checkout'];?>" id="ihc_prorate_show_details_on_checkout" />
			</div>
								...
								<div class="ihc-coupon-admin-box-wrap">
									<div class="ihc-coupon-box-wrap ihc-box-background-f1505b">
										<div class="ihc-coupon-box-main">
											<div class="ihc-coupon-box-title"><?php echo $groupData['name'];?></div>
										...
										<div class="ihc-coupon-box-bottom">
											...
											<div class="ihc-coupon-box-link ihc-js-prorate-delete-group" data-id="<?php echo $id;?>" ><?php esc_html_e("Remove", "ihc"); ?></div>
										</div>
									</div>
								</div>
						<?php endforeach;?>

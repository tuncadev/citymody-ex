      ...
      <h2><?php esc_html_e("Payment Method", 'ihc');?></h2>
       <p><?php esc_html_e("If Multiple Payment services are available, member may choose which one wish to use for current purchase.", 'ihc');?></p>
			 ...
			 <label class="iump_label_shiwtch ihc-switch-button-margin">
				 ...
				 <input type="checkbox" class="iump-switch" onclick="iumpCheckAndH(this, '#ihc_checkout_payment_section');" <?php echo $checked;?> />
				 <div class="switch ihc-display-inline"></div>
			 </label>
			 <input type="hidden" name="ihc_checkout_payment_section" value="<?php echo $meta_arr['ihc_checkout_payment_section'];?>" id="ihc_checkout_payment_section" />
		 	</div>
    </div>
				...
				<div class="iump-form-line iump-no-border">
					...
					<select name="ihc_checkout_payment_theme"><?php
						...
						foreach (array('ihc-select-payment-theme-1' => 'RadioBox', 'ihc-select-payment-theme-2' => 'Logos', 'ihc-select-payment-theme-3' => 'DropDown') as $k=>$v){
							?>
							<option value="<?php echo $k;?>" <?php if ($k==$meta_arr['ihc_checkout_payment_theme']) echo 'selected';?> ><?php echo $v;?></option>
							<?php
						}
					?></select>
				</div>
      ...
      <h2><?php esc_html_e("Dynamic Price box", 'ihc');?></h2>
       <p><?php esc_html_e("Allow members to choose how much to pay for selected Membership.", 'ihc');?></p>
			 ...
			 <label class="iump_label_shiwtch ihc-switch-button-margin">
				 ...
				 <input type="checkbox" class="iump-switch" onclick="iumpCheckAndH(this, '#ihc_checkout_dynamic_price');" <?php echo $checked;?> />
				 <div class="switch ihc-display-inline"></div>
			 </label>
			 <input type="hidden" name="ihc_checkout_dynamic_price" value="<?php echo $meta_arr['ihc_checkout_dynamic_price'];?>" id="ihc_checkout_dynamic_price" />
		 	</div>
    ...
    <div class="iump-form-line iump-no-border">
      <h2><?php esc_html_e("Discount Coupon box", 'ihc');?></h2>
			 ...
			 <label class="iump_label_shiwtch ihc-switch-button-margin">
				 ...
				 <input type="checkbox" class="iump-switch" onclick="iumpCheckAndH(this, '#ihc_checkout_coupon');" <?php echo $checked;?> />
				 <div class="switch ihc-display-inline"></div>
			 </label>
			 <input type="hidden" name="ihc_checkout_coupon" value="<?php echo $meta_arr['ihc_checkout_coupon'];?>" id="ihc_checkout_coupon" />
		 </div>
			...
			<div class="iump-form-line iump-no-border">
			 ...
			 <div>
				<label class="iump_label_shiwtch ihc-switch-button-margin">
					...
					<input type="checkbox" class="iump-switch" onclick="iumpCheckAndH(this, '#ihc_checkout_avoid_free_membership');" <?php echo $checked;?> />
					<div class="switch ihc-display-inline"></div>
				</label>
				<input type="hidden" name="ihc_checkout_avoid_free_membership" value="<?php echo $meta_arr['ihc_checkout_avoid_free_membership'];?>" id="ihc_checkout_avoid_free_membership" />
			</div>
		 </div>
		 <div class="iump-form-line iump-no-border">
			...
			<div>
			 <label class="iump_label_shiwtch ihc-switch-button-margin">
				 ...
				 <input type="checkbox" class="iump-switch" onclick="iumpCheckAndH(this, '#ihc_checkout_payment_method_position');" <?php echo $checked;?> />
				 <div class="switch ihc-display-inline"></div>
			 </label>
			 <input type="hidden" name="ihc_checkout_payment_method_position" value="<?php echo $meta_arr['ihc_checkout_payment_method_position'];?>" id="ihc_checkout_payment_method_position" />
		 </div>
		</div>

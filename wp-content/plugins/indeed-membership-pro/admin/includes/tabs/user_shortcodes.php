			...
			<table class="wp-list-table widefat fixed tags ihc-manage-user-expire">
				...
				<tbody>
					<tr>
						...
						<td><?php esc_html_e('Shortcode Generator for Members Listing Showcase. Check for more details', 'ihc');?> <a target='_blank' href='<?php echo $url."&tab=listing_users";?>'><?php esc_html_e('here', 'ihc');?></a></td>
					</tr>
					<tr>

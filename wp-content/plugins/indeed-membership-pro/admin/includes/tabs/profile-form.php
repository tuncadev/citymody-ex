...
if ( isset($_POST['ihc_save'] ) && !empty($_POST['ihc_admin_profile_form_settings_nonce']) && wp_verify_nonce( $_POST['ihc_admin_profile_form_settings_nonce'], 'ihc_admin_profile_form_settings_nonce' ) ){
      ...
      <div>
        <div class="iump-register-select-template">
          ...
          <?php
            ...
            ?>
              <option value="<?php echo $k;?>" <?php if ($k==$meta_arr['ihc_profile_form_template']) echo 'selected';?> >
                <?php echo $v;?>
              </option>
            <?php
            }

...
$subtab = isset( $_GET['subtab'] ) ? $_GET['subtab'] : 'post_types';
?>
				...
				if ($data && count($data)){
					...
					<?php
						...
						?>">
							...
							<td align="center">
								<i class="fa-ihc ihc-icon-remove-e ihc-js-admin-block-url-delete-block-url" data-key="<?php echo $key;?>" ></i>
							</td>
						</tr>
						<?php
						$i++;
						...
						<?php
							...
							?>
								...
								?>">
									...
									<td align="center">
										<i class="fa-ihc ihc-icon-remove-e ihc-js-admin-block-regex" data-key="<?php echo $key;?>" ></i>
									</td>
								</tr>
							<?php
							$i++;
						...
						<?php
							...
							?>
								...
								?>">
									...
									<td align="center">
										<i class="fa-ihc ihc-icon-remove-e ihc-js-admin-delete-block-url-block" data-key="<?php echo $key;?>" ></i>
									</td>
								</tr>
							<?php
							$i++;
						...
						<?php
							...
							?>
								...
								?>">
									...
									<td align="center">
										<i class="fa-ihc ihc-icon-remove-e ihc-js-admin-delete-block-url-redirect" data-key="<?php echo $key;?>" ></i>
									</td>
								</tr>
							<?php
							$i++;
						...
						<?php
							...
							?>
								...
								?>">
									...
									<td align="center">
										<i class="fa-ihc ihc-icon-remove-e ihc-js-delete-block-url-redirect" data-key="<?php echo $key;?>" ></i>
									</td>
								</tr>
							<?php
							$i++;

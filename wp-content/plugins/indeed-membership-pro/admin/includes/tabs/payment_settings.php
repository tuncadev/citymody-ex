<div class="ihc-subtab-menu">
	...
	<?php //echo "<pre>"; var_dump($items); echo "</pre>"; ?>
...
if (empty($_GET['subtab'])){
	...
	<div class="iump-payment-list-wrapper">
		<div class="iump-payment-box-wrap">
			 ...
			 <a href="<?php echo $url.'&tab='.$tab.'&subtab=stripe_connect';?>">
	...
	switch ($_GET['subtab']){
			...
			<form  method="post">
               ...
               <div class="row ihc-row-no-margin">
							...
							<ul class="ihc-payment-capabilities-list">
								...
								<li><?php esc_html_e('Setup your IPN in order to receive Payment confirmations as: ', 'ihc');?><a target="_blank" href="<?php echo $siteUrl . '?ihc_action=paypal';?>"><?php echo $siteUrl . '?ihc_action=paypal';?></a></li>
									<li><?php esc_html_e("You can find 'Merchant account ID' ", 'ihc');?><?php esc_html_e("click on Account Settings -> Business information -> PayPal Merchant ID.", 'ihc');?></li>
														...
														<ul class="ihc-payment-capabilities-list">
														  <li><?php esc_html_e("Login in ", 'ihc'); ?> <a target="_blank" href="https://developer.paypal.com/">developer account </a> <?php esc_html_e("and go to Dashboard -> My Apps & Credentials and create an app.", 'ihc');?></li>
															...
															<li><?php esc_html_e("Set ", 'ihc');?><b><?php echo $siteUrl . '?ihc_action=paypal'?></b> <?php esc_html_e("in Account Settings -> Website payments -> Instant payment notifications.",'ihc');?></li>
														</ul>
		...
		case 'stripe':
			...
			<div class="iump-page-title">Ultimate Membership Pro -
				<span class="second-text">
					<?php esc_html_e('Stripe Standard Services', 'ihc');?>
				</span>
			</div>
			<form  method="post">
				<input type="hidden" name="ihc-payment-settings-nonce" value="<?php echo wp_create_nonce( 'ihc-payment-settings-nonce' );?>" />
			<div class="ihc-stuffbox">
						...
						<div class="inside">
							...
							<div class="ihc-alert-warning"><?php echo esc_html__('We recommend to use', 'ihc'); ?> <a href="<?php echo $url.'&tab='.$tab.'&subtab=stripe_connect';?>"><strong>Stripe Connect</strong></a> <?php echo esc_html__('gateway instead being more stable and customizable. Stripe Standard will become deprecated soon.', 'ihc');?></div>
                            </div>
							<div class="ihc-wrapp-submit-bttn iump-submit-form">
								<input id="ihc_submit_bttn" type="submit" value="<?php esc_html_e('Save Changes', 'ihc');?>" name="ihc_save" class="button button-primary button-large" />
							</div>
                  ...
                  <div class="col-xs-6">
						...
						<div class="iump-form-line">
							...
							<ul class="ihc-info-list">
								...
								<li><?php esc_html_e('3. After that click on "Developers" -> "Overview" and check the current "API version". Be sure that the latest (2020-08-27) is chosen and set as Default.', 'ihc');?></li>
								<li><?php esc_html_e('4. Then select "API Keys" and check "Publishable Key" and "Secret Key". If have been created with an old API version, you have to delete and re-create them. If does not exist yet create them.', 'ihc');?></li>
								<li><?php esc_html_e('5. Go to "Webhooks" and press "Add endpoint".', 'ihc');?></li>
								<li><?php echo esc_html__("6. Set your Endpoint URL to: ", 'ihc') . '<strong>' . $notify_url . '</strong> and choose all the events from "Charge", "Customer", "Invoice", "Subscription Schedule". Be sure that latest API version is used for webhooks.';?></li>
								<li><?php echo esc_html__('7. If some of your cardholders required 3D Secure authentication step you may configure in ', 'ihc');?>  <strong>Manage payments that require 3D Secure</strong> <?php esc_html_e(' from ', 'ihc');?> <a href="https://dashboard.stripe.com/account/billing/automatic" target="_blank">https://dashboard.stripe.com/account/billing/automatic</a></li>
								<li><?php echo esc_html__("8. Customize Stripe Checkout page and Emails on ", 'ihc') . '<a href="https://dashboard.stripe.com/account/branding" target="_blank">https://dashboard.stripe.com/account/branding</a>';?></li>
								</ul>
						</div>
		...
		<div class="ihc-stuffbox">
					...
					<div class="inside">
						...
						<?php if(!$meta_arr['ihc_stripe_checkout_v2_status']){ ?>
								<div class="ihc-alert-warning"><?php echo esc_html__('We recommend ', 'ihc'); ?> <a href="<?php echo $url.'&tab='.$tab.'&subtab=stripe_connect';?>"><strong>Stripe Connect</strong></a> <?php echo esc_html__('Payment Service to have access on all Stripe functionalities and complete Subscriptions management.', 'ihc');?></div>
						<?php }else{?>
								<div class="ihc-alert-warning"><?php echo esc_html__('Switch to ', 'ihc'); ?> <a href="<?php echo $url.'&tab='.$tab.'&subtab=stripe_connect';?>"><strong>Stripe Connect</strong></a> <?php echo esc_html__('Payment Service to have access on all Stripe functionalities and complete Subscriptions management. Follow ', 'ihc');?>
                  ...
                  <div class="col-xs-6">
					...
					<div class="iump-form-line">
						...
						<ul class="ihc-payment-capabilities-list">
							...
							<li><?php esc_html_e('Verify that you are utilizing the most recent API version', 'ihc');?> <b>(2022-08-01)</b>. <?php esc_html_e(' Check in ' , 'ihc');?><b><a href="https://stripe.com/docs/api/versioning" target="_blank"><?php esc_html_e('API versioning', 'ihc');?></a></b> for more details.</li>
							<li><?php esc_html_e('Go to "Webhooks" and press "Add endpoint".', 'ihc');?></li>
							<li><?php echo esc_html__("Set your Endpoint URL to: ", 'ihc') . '<strong>' . $notify_url . '</strong>';?> <?php esc_html_e(' and select all of the events from "Charge", "Customer", "Invoice", "Subscription Schedule". In "Checkout" event select ', 'ihc');?><code>checkout.session.completed</code>.</li>
				...
				<div class="ihc-stuffbox">
					...
					<div class="inside">
						<div class="iump-form-line">
							...
							<input type="text" value="<?php echo $meta_arr['ihc_authorize_login_id'];?>" name="ihc_authorize_login_id" class="form-control" /></div>
							<div class="input-group"><span class="input-group-addon"><?php esc_html_e('Transaction Key:', 'ihc');?></span>
							<input type="text" value="<?php echo $meta_arr['ihc_authorize_transaction_key'];?>" name="ihc_authorize_transaction_key" class="form-control" /></div>
						</div>
					</div>
				...
				<div class="ihc-stuffbox">
					...
					<div class="inside">
						<div class="iump-form-line">
							...
							<input type="text" value="<?php echo $meta_arr['ihc_twocheckout_api_user'];?>" name="ihc_twocheckout_api_user" class="form-control" /></div>


							<div class="input-group"><span class="input-group-addon"><?php esc_html_e('API Password:', 'ihc');?></span>
							<input type="text" value="<?php echo $meta_arr['ihc_twocheckout_api_pass'];?>" name="ihc_twocheckout_api_pass" class="form-control" /></div>


							<div class="input-group"><span class="input-group-addon"><?php esc_html_e('API Private Key:', 'ihc');?></span>
							<input type="text" value="<?php echo $meta_arr['ihc_twocheckout_private_key'];?>" name="ihc_twocheckout_private_key" class="form-control" /></div>


							<div class="input-group"><span class="input-group-addon"><?php esc_html_e('Merchant Code (Account Number):', 'ihc');?></span>
							<input type="text" value="<?php echo $meta_arr['ihc_twocheckout_account_number'];?>" name="ihc_twocheckout_account_number" class="form-control" /></div>


							<div class="input-group"><span class="input-group-addon"><?php esc_html_e('Secret Word:', 'ihc');?></span>
							<input type="text" value="<?php echo $meta_arr['ihc_twocheckout_secret_word'];?>" name="ihc_twocheckout_secret_word" class="form-control" /></div>
					...
					<div class="ihc-stuffbox">
						...
						<div class="ihc-stuffbox">
								...
								<div class="iump-form-line iump-no-border">
									<div class="row ihc-row-no-margin">
										<div class="col-xs-5 ihc-col-no-padding">
											...
											<input type="text" name="ihc_braintree_merchant_id" value="<?php echo $meta_arr['ihc_braintree_merchant_id'];?>" class="form-control" /></div>

											<div class="input-group"><span class="input-group-addon"><?php esc_html_e('Public Key:', 'ihc');?></span>
											<input type="text" name="ihc_braintree_public_key" value="<?php echo $meta_arr['ihc_braintree_public_key'];?>" class="form-control" /></div>

											<div class="input-group"><span class="input-group-addon"><?php esc_html_e('Private Key:', 'ihc');?></span>
											<input type="text" name="ihc_braintree_private_key" value="<?php echo $meta_arr['ihc_braintree_private_key'];?>" class="form-control" /></div>
							...
							<label class="iump_label_shiwtch ihc-switch-button-margin">
								...
								<h4><input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_braintree_sandbox');" <?php echo $checked;?> />
								<div class="switch ihc-display-inline"></div>
					...
					<div class="ihc-stuffbox">
						...
						<div class="inside">
							<div class="iump-form-line">
								...
								<input type="text" name="ihc_mollie_api_key" value="<?php echo $meta_arr['ihc_mollie_api_key'];?>" class="form-control"/>
							</div>
						</div>
					</div>
				</div>
					...
					<h4><?php esc_html_e( 'Setup Intructions', 'ihc' );?> </h4>
							...
							<ul class="ihc-payment-capabilities-list">
							  <li><?php esc_html_e('In order to use PayPal Express Checkout you must set your IPN. First go to: ', 'ihc');?><a href="https://www.paypal.com/signin" target="_blank">https://www.paypal.com/signin</a><?php esc_html_e(' or: ', 'ihc');?></li>
								...
								<li><?php esc_html_e("Login with your credentials and go to 'Account Settings' (top-right of page)", 'ihc');?></li>
								<li><?php esc_html_e("After that go to 'Notifications' and next Update the 'Instant payment notifications' ", 'ihc');?></li>
								<li><?php esc_html_e('Set your IPN at: ', 'ihc');?><a href="<?php echo $siteUrl . '?ihc_action=paypal_express_checkout_ipn';?>"><?php echo $siteUrl . '?ihc_action=paypal_express_checkout_ipn';?></a></li>
							</ul>
		...
		case 'pagseguro':
					...
					<div class="ihc-stuffbox">
						...
						<div class="inside">
							<div class="iump-form-line">
								<div class="row ihc-row-no-margin">
										<div class="col-xs-5 ihc-col-no-padding">
								<div class="input-group"><span class="input-group-addon"><?php esc_html_e('Pagseguro Account E-mail:', 'ihc');?></span> <input type="text" value="<?php echo $meta_arr['ihc_pagseguro_email'];?>" name="ihc_pagseguro_email" class="form-control" /></div>

										<div class="input-group"><span class="input-group-addon"><?php esc_html_e('Token:', 'ihc');?></span> <input type="text" value="<?php echo $meta_arr['ihc_pagseguro_token'];?>" name="ihc_pagseguro_token" class="form-control" /></div>
						...
						<ul class="ihc-payment-capabilities-list">
							...
							<li><?php esc_html_e(' In Transaction notification set the Notification URL as: ', 'ihc'); ?><a href="<?php echo $siteUrl . '?ihc_action=pagseguro';?>"><?php echo $siteUrl . '?ihc_action=pagseguro';?></a></li>
						</ul>
					</div>
			...
			case 'stripe_connect':
				if ( isset( $_GET['access_token'] ) && $_GET['access_token'] !== ''	&& isset( $_GET['stripe_publishable_key'] )
					...
					&& isset( $_GET['code'] ) && $_GET['code'] !== '' && wp_verify_nonce( $_GET['code'], 'ihc_stripe_connect_auth' ) ){
							// save the credentials
							if ( $_GET['sandbox'] ){
									// sandbox
									update_option( 'ihc_stripe_connect_test_client_secret', esc_sql( $_GET['access_token'] ) );
									update_option( 'ihc_stripe_connect_test_publishable_key', esc_sql( $_GET['stripe_publishable_key'] ) );
									update_option( 'ihc_stripe_connect_test_account_id', esc_sql( $_GET['stripe_user_id'] ) );
							} else {
									// live
									update_option( 'ihc_stripe_connect_client_secret', esc_sql( $_GET['access_token'] ) );
									update_option( 'ihc_stripe_connect_publishable_key', esc_sql( $_GET['stripe_publishable_key'] ) );
									update_option( 'ihc_stripe_connect_account_id', esc_sql( $_GET['stripe_user_id'] ) );
							}

							if ( get_option( 'ihc_stripe_connect_activation_time' ) === false ){
									update_option( 'ihc_stripe_connect_activation_time', time() );
							}
				} else if ( isset( $_GET['error_deauth'] ) && $_GET['error_deauth'] == 1 ){
						?>
				...
				<form  method="post">
					...
					<div class="ihc-stuffbox">
		                ...
		                <h2><?php esc_html_e('Activate Stripe Connect Payment Service', 'ihc');?> </h2>
										<label class="iump_label_shiwtch ihc-switch-button-margin">
											...
											<input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_stripe_connect_status');" <?php echo $checked;?> />
											<div class="switch ihc-display-inline"></div>
										</label>
										<input type="hidden" value="<?php echo $meta_arr['ihc_stripe_connect_status'];?>" name="ihc_stripe_connect_status" id="ihc_stripe_connect_status" />
					...
					<div class="ihc-stuffbox">
						...
						<div class="inside">
							...
							<div class="iump-form-line">
								<div>
									...
									<div class="ihc-switch_andtype">
											<input type="checkbox" <?php echo $checked;?> name="ihc-switch_andtype" class="ihc-switch_andtype-checkbox" id="onoff_ics_about_page_enable" onchange="iumpCheckAndH(this,'#ihc_stripe_connect_live_mode');ihcUpdateStripeConnectAuthUrl();">
									...
									<input type="hidden" name="ihc_stripe_connect_live_mode" value="<?php echo $meta_arr['ihc_stripe_connect_live_mode'];?>" id="ihc_stripe_connect_live_mode" />
								</div>
							</div>
							<div class="ihc-stripe-connect-live-wrapper">
								...
								?>
								<div class="ihc-js-stripe-connect-live <?php echo $extraClass;?>">
										<?php
										...
										<div class="iump-form-line">
											...
											<a href="<?php echo $authUrl;?>" class="ihc-stripe-connect-btn"><span>Connect with Stripe</span></a>
										</div>
										...
										<?php else :?>
											<div class="iump-form-line">
												...
												<span data-url="<?php echo $deauthUrl;?>" data-refresh_url="<?php echo admin_url('admin.php?page=ihc_manage&tab=payment_settings&subtab=stripe_connect');?>" class="ihc-stripe-connect-btn ihc-js-deauth-from-stripe-checkout-bttn"><span>Deauth from Stripe</span></span>
												<p><?php esc_html_e('or ReConnect with a new Stripe Account:', 'ihc');?></p>
													<a href="<?php echo $authUrl;?>" class="ihc-stripe-connect-btn"><span>ReConnect with Stripe</span></a>
												<div>
													<input type="hidden" value="<?php echo $meta_arr['ihc_stripe_connect_publishable_key'] ?>" data-type="pk_key" />
													<input type="hidden" value="<?php echo $meta_arr['ihc_stripe_connect_client_secret'] ?>" data-type="client_key" />
													<input type="hidden" value="<?php echo $meta_arr['ihc_stripe_connect_account_id'] ?>" data-type="acct_id" />
												</div>
											</div>
										<?php endif;?>
										<div class="iump-form-line">
											...
											<p><strong><?php echo $notify_url; ?></strong></p>
								...
								?>
								<div class="ihc-js-stripe-connect-sandbox <?php echo $extraClass;?>">
									<?php
									...
									<?php else :?>
										<div class="iump-form-line">
											...
											<span data-url="<?php echo $deauthUrl;?>"
											...
											<a href="<?php echo $authUrl;?>" class="ihc-stripe-connect-btn" ><span>ReConnect with Stripe</span></a>
											<div>
												<input type="hidden" value="<?php echo $meta_arr['ihc_stripe_connect_test_publishable_key'] ?>" data-type="pk_key" />
												<input type="hidden" value="<?php echo $meta_arr['ihc_stripe_connect_test_client_secret'] ?>" data-type="client_key" />
												<input type="hidden" value="<?php echo $meta_arr['ihc_stripe_connect_test_account_id'] ?>" data-type="acct_id" />
											</div>
										</div>
									<?php endif;?>
									<div class="iump-form-line">
								...
								<div class="iump-form-line">
									...
									<ul class="ihc-payment-capabilities-list">
										...
										<li><?php esc_html_e('Stripe Connect payment service includes an 1% application fee for payment processing.', 'ihc');?></li>
									</ul>
								...
								<!--div class="iump-form-line">
									...
									<label class="iump_label_shiwtch ihc-switch-button-margin">
										...
										<input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_stripe_connect_payment_request');" <?php echo $checked;?> />
										<div class="switch ihc-display-inline"></div>
									</label>
									<input type="hidden" value="<?php echo $meta_arr['ihc_stripe_connect_payment_request'];?>" name="ihc_stripe_connect_payment_request" id="ihc_stripe_connect_payment_request" />
								...
								<div class="iump-form-line">
									...
									<label class="iump_label_shiwtch ihc-switch-button-margin">
										...
										<input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_stripe_connect_saved_cards');" <?php echo $checked;?> />
										<div class="switch ihc-display-inline"></div>
									</label>
									<input type="hidden" value="<?php echo $meta_arr['ihc_stripe_connect_saved_cards'];?>" name="ihc_stripe_connect_saved_cards" id="ihc_stripe_connect_saved_cards" />
			                    ...
			                    <input type="text" value="<?php echo $meta_arr['ihc_stripe_connect_descriptor'];?>" name="ihc_stripe_connect_descriptor" class="form-control">
										    </div>
										</div>
									</div>
		                  ...
		                  <div class="col-xs-6 ihc-col-no-padding">
												<div class="iump-form-line iump-no-border">
													...
													<select name="ihc_stripe_connect_locale_code" class="form-control">
															...
															?>
															<?php foreach ($locales as $k=>$v):?>
																	<option value="<?php echo $k;?>" <?php if ($meta_arr['ihc_stripe_connect_locale_code']==$k) echo 'selected';?> ><?php echo $v;?></option>
															<?php endforeach;?>
													</select>
									</div>
					...
					<div class="row ihc-row-no-margin">
						<div class="col-xs-3 ihc-col-no-padding">
							<div class="iump-form-line iump-no-border input-group">
								<span class="input-group-addon"><?php esc_html_e('Label:', 'ihc');?></span>
								<input type="text" name="ihc_stripe_connect_label" class="form-control" value="<?php echo $meta_arr['ihc_stripe_connect_label'];?>" />
							</div>

							<div class="iump-form-line iump-no-border input-group">
								<span class="input-group-addon"><?php esc_html_e('Order:', 'ihc');?></span>
								<input type="number" min="1" name="ihc_stripe_connect_select_order" class="form-control" value="<?php echo $meta_arr['ihc_stripe_connect_select_order'];?>" />
							</div>
							</div>
		            </div>
								<!-- developer -->

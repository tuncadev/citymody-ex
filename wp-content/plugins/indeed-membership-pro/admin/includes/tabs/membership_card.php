...
<form  method="post">
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<div class="iump-form-line">
				...
				<label class="iump_label_shiwtch ihc-switch-button-margin">
					...
					<input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_membership_card_enable');" <?php echo $checked;?> />
			...
			<div class="iump-form-line">
				...
				<select name="ihc_membership_card_template" class="iump-form-select ihc-form-element ihc-form-element-select ihc-form-select">
					...
					foreach ($templates as $k=>$v):
						?>
						<option value="<?php echo $k;?>" <?php if ($k==$data['metas']['ihc_membership_card_template']){
							 echo 'selected';
						}
						?>
						>
			...
			<div class="iump-form-line">
				...
				<div class="row">
					<div class="col-xs-2">
						<input type="text" class="ihc_membership_card_background_color" name="ihc_membership_card_background_color" value="<?php echo $data['metas']['ihc_membership_card_background_color'];?>"/>
						<div>
							<i>ex: #000000</i>
						</div>
					</div>
			...
			<div class="iump-form-line">
				...
				<select name="ihc_membership_card_size" class="iump-form-select ihc-form-element ihc-form-element-select ihc-form-select ihc-js-membership-card-select-size">
					...
					foreach ($templates as $k=>$v):
						?>
						<option value="<?php echo $k;?>" <?php if ($k==$data['metas']['ihc_membership_card_size']){
							 echo 'selected';
						}
						?>
						>
				...
				?></select>
				<div class="ihc-membership-card-size-image-example-wrapper" data-path_to_image="<?php echo IHC_URL . 'admin/assets/images/';?>" >
					<img src="<?php echo $imageHref;?>" class="ihc-membership-card-size-image-example membership-card-size-small"/>
				</div>
			</div>
			...
			<div class="col-xs-5">
				...
				<div class="ihc-membership-card-settings-image-type-box-wrapper">
					<div class="ihc-membership-card-settings-image-type-box">
						...
						<img src="<?php echo IHC_URL;?>assets/images/default-logo1.png" class="ihc-membership-card-settings-image-example"/>
					</div>
					<div class="ihc-membership-card-settings-image-type-box">
						...
						<img src="<?php echo IHC_URL;?>assets/images/no-avatar.png" class="ihc-membership-card-settings-image-example"/>
					</div>
				</div>
				...
				?>
				<input type="text" class="ihc-membership-card-settings-image <?php echo $class;?>" name="ihc_membership_card_image" value="<?php echo $data['metas']['ihc_membership_card_image'];?>" onClick="openMediaUp(this);" />
			...
			<div class="row">
				...
				<div class="col-xs-3">
								...
								<label class="iump_label_shiwtch ihc-switch-button-margin">
									...
									<input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_membership_member_since_enable');" <?php echo $checked;?> />
									<div class="switch ihc-display-inline"></div>
								</label>
							...
							<p><?php esc_html_e('(Optional) The unique ID generated for each member by WordPress. Customize also the label besides this information.', 'ihc');?></p>
								...
								<div class="col-xs-3">
														<label class="iump_label_shiwtch ihc-switch-button-margin">
															...
															<input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_membership_member_show_uid');" <?php echo $checked;?> />
															<div class="switch ihc-display-inline"></div>
														</label>
														<input type="hidden" name="ihc_membership_member_show_uid" value="<?php echo $data['metas']['ihc_membership_member_show_uid'];?>" id="ihc_membership_member_show_uid" />
														<div class="input-group">
															<span class="input-group-addon" id="basic-addon1"><?php esc_html_e('Label:', 'ihc');?></span>
															<input type="text" class="form-control" name="ihc_membership_member_uid_label" value="<?php echo $data['metas']['ihc_membership_member_uid_label'];?>">
														</div>
										</div>
								</div>
						</div>
									...
									<div class="col-xs-3">
										<select name="ihc_membership_member_show_extrafields[]" multiple size="5" class="iump-form-select ihc-form-element ihc-form-element-select ihc-form-select">
											...
											foreach ($extra_fields as $k=>$v):
												?>
												<option value="<?php echo $k;?>" <?php echo (is_array($data['metas']['ihc_membership_member_show_extrafields']) && in_array($k,$data['metas']['ihc_membership_member_show_extrafields'])) ? 'selected' : ''; ?> >
												<?php echo $v;?></option>
												<?php
											endforeach;
										?></select>
			...
			<?php if (!empty($levels)):?>
				<div class="iump-form-line">
					...
					<div class="ihc-membership-card-settings-levels">
						...
						<input type="checkbox" <?php echo $checked;?> onClick="ihcAddToHiddenWhenUncheck(this, '<?php echo $lid;?>', '#ihc_membership_card_exclude_levels');" /> <?php echo $level_arr['label'];?>
					</div>
					<?php endforeach;?>
				</div>
			<?php endif;?>
		...
		<div class="iump-form-line">
			...
			<textarea name="ihc_membership_card_custom_css" class="ihc-custom-css-box"><?php echo stripslashes($data['metas']['ihc_membership_card_custom_css']);?></textarea>
		</div>

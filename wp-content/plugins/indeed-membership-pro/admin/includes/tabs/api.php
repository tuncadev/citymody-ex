...
foreach ($actions as $slug=>$array):?>
	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			...
			<a href="" target="_blank"><?php echo $siteUrl . '?ihc_action=api-gate&ihch=';?><span class="ihc-base-api-link-hash"><?php echo $data['metas']['ihc_api_hash'];?></span><?php echo '&action='.$slug;
				$i = 1;

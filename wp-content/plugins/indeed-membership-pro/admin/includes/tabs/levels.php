<div class="ihc-subtab-menu">
	<a class="ihc-subtab-menu-item <?php echo (isset($_REQUEST['new_level']) && $_REQUEST['new_level'] =='true') ? 'ihc-subtab-selected' : '';?>" href="<?php echo $url.'&tab=levels&new_level=true';?>"> <?php esc_html_e('Add New Membership', 'ihc');?></a>
	<a class="ihc-subtab-menu-item <?php echo (!isset($_REQUEST['new_level'])) ? 'ihc-subtab-selected' : '';?>" href="<?php echo $url.'&tab=levels';?>"><?php esc_html_e('Manage Memberships', 'ihc');?></a>
	<a class="ihc-subtab-menu-item" href="<?php echo $url.'&tab=subscription_plan';?>"><?php esc_html_e('Subscription Plan Showcase', 'ihc');?></a>
		...
		<form method="post" action="<?php echo $url.'&tab=levels';?>">
                ...
                <div class="row">
                	<div class="col-xs-4">
                             <div class="input-group">
                                ...
                                <input name="label" class="form-control" type="text" value="<?php echo $level_data['label'];?>" placeholder="<?php esc_html_e('suggestive Membership Name', 'ihc');?>"/>
                             </div>
                     </div>
                 </div>
                 </div>
                ...
                <div class="row">
                	<div class="col-xs-4">
                             <div class="input-group">
                                ...
                                <input name="name" class="form-control" type="text" value="<?php echo $level_data['name'];?>" id="level_slug_id" onBlur="ihcUpdateLevelSlugSpan();"   placeholder="<?php esc_html_e('ex: unique_plan_slug', 'ihc');?>"/>
					...
					<p><?php esc_html_e('If you wish to have Recurring steps choose "Recurring Subscription" type. All others have OneTime step.', 'ihc');?></p>
						...
						<div id="limited_access_metas" class="ihc-membership-type-settings <?php if ($level_data['access_type']=='limited') echo 'ihc-display-block'; else echo 'ihc-display-none';?>">
							<div>
								...
								<input type="number" value="<?php echo $level_data['access_limited_time_value'];?>" name="access_limited_time_value" min="1" max="31" class="ihc-access_limited_time_value"/>
						...
						<div id="regular_period_access_metas" class="ihc-membership-type-settings <?php if ($level_data['access_type']=='regular_period') echo 'ihc-display-block'; else echo 'ihc-display-none';?>">
							<div>
								...
								<input type="number" value="<?php echo $level_data['access_regular_time_value'];?>" name="access_regular_time_value" min="1"  class="ihc-access_regular_time_value"/>
							...
							?>
							<div class="ihc-specific-message <?php echo $display; ?> ">
						...
						<div id="set_grace_period" class="iump-form-line iump-no-border form-required ihc-set_expired_level <?php if (isset($level_data['access_type']) && $level_data['access_type']!='unlimited') echo 'ihc-display-block'; else echo 'ihc-display-none';?>">
							<div>
								...
								<div  class="ihc-display-inline">
									<input type="number" value="<?php echo $level_data['grace_period'];?>" name="grace_period" min="1"  class="ihc-grace_period"/> <?php echo esc_html__('days', 'ihc'); ?>
					...
					<div id="payment_options"  class="<?php if ($level_data['payment_type']=='free') echo 'ihc-display-none'; else echo ' ihc-display-block' ?>" >
						...
						?>
						<div class="iump-form-line iump-no-border <?php echo $display;?>" id="regular_period_billing">
						...
						?>
						<div class="iump-no-border ihc-trial_period_billing <?php echo $display;?>" id="trial_period_billing">
                        ...
                        <p><?php esc_html_e('Setup trial or initial payment details only if you wish your Subscription to have one. Otherwise leave next fields ', 'ihc');?> <strong><?php esc_html_e(' empty ', 'ihc');?></strong></p>
							<div class="iump-form-line iump-no-border" >
                                ...
                                <div class="ihc-trial-price-wrapper">
                                          <div class="input-group">
                                                  <input type="number" value="<?php echo $level_data['access_trial_price'];?>" name="access_trial_price" min="0" step="0.01"  class="form-control ihc-trial-price"/>
                                                  <div class="input-group-addon">
                                                  <?php
                                                      echo $currency;
                                                  ?>
							...
							<div id="trial_certain_period" class="<?php if ($level_data['access_trial_type']==1) echo 'ihc-display-block'; else echo 'ihc-display-none';?>">
								...
								<input type="number" value="<?php echo $level_data['access_trial_time_value'];?>" name="access_trial_time_value" min="1" max="31" class="ihc-access_trial_time_value"/>
							...
							<div class="iump-form-line iump-no-border <?php if ($level_data['access_trial_type']==2) echo 'ihc-display-block'; else echo 'ihc-display-none';?>"  id="trial_couple_cycles">
								...
								<input type="number" value="<?php echo $level_data['access_trial_couple_cycles'];?>" name="access_trial_couple_cycles" min="1" class="ihc-access_trial_couple_cycles"/>
                                <?php
            ...
            <div  class="iump-form-line iump-no-border">
					...
					<div  class="iump-form-line iump-no-border">
						...
						<input name="button_label" type="text" value="<?php echo $level_data['button_label'];?>" class="ihc-plan-details-price-text">
				...
				<div class="inside">
					...
					<div class="iump-form-line">
						...
						<div>
							...
							<input type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, 'unreg', '<?php echo '#levelcond';?>');" /><span class="ihc-checkbox-align"> <?php esc_html_e('Unregistered Users', 'ihc');?></span>
						</div>
						<div>
							<?php $checked = (in_array('no_pay', $hidden_arr)) ? 'checked' : '';?>
							<input type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, 'no_pay', '<?php echo '#levelcond';?>');" /><span class="ihc-checkbox-align"> <?php esc_html_e('Registered Users without any payment proceeded.', 'ihc');?></span>
						</div>
						...
						<?php foreach ($levels as $levelid=>$larr):?>
							...
							<div class="ihc-membership-plus-checkbox-wrapper">
								...
								<input type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, '<?php echo $levelid;?>', '<?php echo '#levelcond';?>');" /> <span class="ihc-checkbox-align"  class="<?php echo $spanclass;?>"><?php echo $larr['label'];?></span>
							</div>
						<?php endforeach;?>
			...
			<div class="ihc-stuffbox ihc-stuffbox-magic-feat">
				...
				<div class="inside">
					<div class="iump-form-line">
						...
						?>
							<div id="iump_current_product_level"><?php esc_html_e('Current Product assign: ', 'ihc');?><a href="<?php echo admin_url('post.php?post=' . $product_id . '&action=edit');?>" target="_blank"><?php echo $product_name;?></a>
						...
						?>
						<div id="iump_change_level_product_relation" class="<?php echo $display_hidden;?>">
			...
			<div class="ihc-stuffbox ihc-stuffbox-magic-feat">
				...
				<div class="inside">
					<div class="iump-form-line">
						...
						<input type="text" class="form-control ihc-badge-imag" onclick="openMediaUp(this);" value="<?php echo $level_data['badge_image_url'];?>" name="badge_image_url" id="badge_image_url" >
	...
	<form class="ihc-memberships-lists-wrapper">
		<?php
				if ( isset( $results['success'] ) && $results['success'] === false ){
					?>
							<div class="ihc-warning-box"><?php echo $results['reason'];?></div>
					<?php
				} else if ( isset( $results['success'] ) && $results['success'] === true ){
						?>
							<div class="ihc-success-box"><?php echo $results['reason'];?></div>
						<?php
				}
				?>
			<div>
							...
							<div class="iump-rsp-table ihc-sortable-table-wrapp">
								...
								<?php
									...
									foreach ($levels as $k=>$v){
										...
										?>
											  <tr onMouseOver="ihcDhSelector('#level_tr_<?php echo $k;?>', 1);" onMouseOut="ihcDhSelector('#level_tr_<?php echo $k;?>', 0);" id="level_sort_<?php echo $i;?>">
											      ...
											      <td class="column column-primary">
													<?php echo $v['name'];?>
													<div class="ihc-buttons-rsp ihc-visibility-hidden" id="level_tr_<?php echo $k;?>">
														<a class="iump-btns" href="<?php echo $url.'&tab=levels&edit_level='.$k;?>"><?php esc_html_e('Edit', 'ihc');?></a>

														<div class="iump-btns ihc-js-delete-level ihc-delete-link" data-id="<?php echo $k;?>"><?php esc_html_e('Delete', 'ihc');?></div>
													</div>

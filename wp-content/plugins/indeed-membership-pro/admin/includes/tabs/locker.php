...
$subtab = isset( $_REQUEST['subtab'] ) ? $_REQUEST['subtab']  : 'lockers_list';
?>
<div class="ihc-subtab-menu">
	<a class="ihc-subtab-menu-item <?php echo ( $subtab =='add_new') ? 'ihc-subtab-selected' : '';?>" href="<?php echo $url.'&tab='.$tab.'&subtab=add_new';?>"><?php esc_html_e('Add New Locker Template', 'ihc');?></a>
	<a class="ihc-subtab-menu-item <?php echo ( $subtab =='lockers_list' ) ? 'ihc-subtab-selected' : '';?>" href="<?php echo $url.'&tab='.$tab.'&subtab=lockers_list';?>"><?php esc_html_e('Manage Lockers', 'ihc');?></a>
							...
							<select name="ihc_locker_template" id="ihc_locker_template" onChange="setAddVal(this, '#ihc_locker_login_template');ihcLockerPreview();" class="ihc_profile_form_template-st">
								<?php
									foreach($templates as $k=>$v){
										?>
											<option value="<?php echo $k;?>" <?php if($k==$meta_arr['ihc_locker_template']){
												echo 'selected';
											}
											?> >
												<?php echo $v;?>
				...
				<div>
						...
						foreach($templates as $k=>$v){
							...
							">
								...
								<td>
									<span class="ihc-js-admin-delete-locker ihc-delete-link" data-id="<?php echo $k;?>" >

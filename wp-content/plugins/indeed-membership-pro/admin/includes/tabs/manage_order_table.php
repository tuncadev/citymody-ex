<?php
if ( isset($_POST['ihc_save'] ) && !empty($_POST['ihc_manage_order_table_nonce']) && wp_verify_nonce( $_POST['ihc_manage_order_table_nonce'], 'ihc_manage_order_table_nonce' ) ){
                ...
                <div class="iump-form-line iump-no-border">
                  ...
                  <div>
                    <label class="iump_label_shiwtch ihc-switch-button-margin">
                      ...
                      <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_order_memberships_column');" <?php echo $checked;?> />
                      <div class="switch ihc-display-inline"></div>
                    </label>
                    <input type="hidden" name="ihc_show_order_memberships_column" value="<?php echo $data['metas']['ihc_show_order_memberships_column'];?>" id="ihc_show_order_memberships_column" />
                  </div>
                </div>
              </th>
              ...
              <div class="iump-form-line iump-no-border">
                ...
                <div>
                  <label class="iump_label_shiwtch ihc-switch-button-margin">
                    ...
                    <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_total_amount_column');" <?php echo $checked;?> />
                    <div class="switch ihc-display-inline"></div>
                  </label>
                  <input type="hidden" name="ihc_show_total_amount_column" value="<?php echo $data['metas']['ihc_show_total_amount_column'];?>" id="ihc_show_total_amount_column" />
                </div>
              </div>
            </th>
            ...
            <div class="iump-form-line iump-no-border">
              ...
              <div>
                <label class="iump_label_shiwtch ihc-switch-button-margin">
                  ...
                  <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_payment_method_column');" <?php echo $checked;?> />
                  <div class="switch ihc-display-inline"></div>
                </label>
                <input type="hidden" name="ihc_show_payment_method_column" value="<?php echo $data['metas']['ihc_show_payment_method_column'];?>" id="ihc_show_payment_method_column" />
              </div>
            </div>
          </th>
          ...
          <div class="iump-form-line iump-no-border">
            ...
            <div>
              <label class="iump_label_shiwtch ihc-switch-button-margin">
                ...
                <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_date_column');" <?php echo $checked;?> />
                <div class="switch ihc-display-inline"></div>
              </label>
              <input type="hidden" name="ihc_show_date_column" value="<?php echo $data['metas']['ihc_show_date_column'];?>" id="ihc_show_date_column" />
            </div>
          </div>
        </th>
        ...
        <div class="iump-form-line iump-no-border">
          ...
          <div>
            <label class="iump_label_shiwtch ihc-switch-button-margin">
              ...
              <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_coupon_column');" <?php echo $checked;?> />
              <div class="switch ihc-display-inline"></div>
            </label>
            <input type="hidden" name="ihc_show_coupon_column" value="<?php echo $data['metas']['ihc_show_coupon_column'];?>" id="ihc_show_coupon_column" />
          </div>
        </div>
        </th>
        ...
        <div class="iump-form-line iump-no-border">
          ...
          <div>
            <label class="iump_label_shiwtch ihc-switch-button-margin">
              ...
              <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_transaction_column');" <?php echo $checked;?> />
              <div class="switch ihc-display-inline"></div>
            </label>
            <input type="hidden" name="ihc_show_transaction_column" value="<?php echo $data['metas']['ihc_show_transaction_column'];?>" id="ihc_show_transaction_column" />
          </div>
        </div>
        </th>
        ...
        <div class="iump-form-line iump-no-border">
          ...
          <div>
            <label class="iump_label_shiwtch ihc-switch-button-margin">
              ...
              <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_invoice_column');" <?php echo $checked;?> />
              <div class="switch ihc-display-inline"></div>
            </label>
            <input type="hidden" name="ihc_show_invoice_column" value="<?php echo $data['metas']['ihc_show_invoice_column'];*/?>" id="ihc_show_invoice_column" />
          </div>
        </div>
      </th>-->
        ...
        <div class="iump-form-line iump-no-border">
          ...
          <div>
            <label class="iump_label_shiwtch ihc-switch-button-margin">
              ...
              <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_order_status_column');" <?php echo $checked;?> />
              <div class="switch ihc-display-inline"></div>
            </label>
            <input type="hidden" name="ihc_show_order_status_column" value="<?php echo $data['metas']['ihc_show_order_status_column'];?>" id="ihc_show_order_status_column" />
          </div>
        </div>
        </th>
        </tr>
  ...
  <div class="iump-form-line">
    ...
    <div>
      <label class="iump_label_shiwtch ihc-switch-button-margin">
        ...
        <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_taxes_column');" <?php echo $checked;?> />
        <div class="switch ihc-display-inline"></div>
      </label>
      <input type="hidden" name="ihc_show_taxes_column" value="<?php echo $data['metas']['ihc_show_taxes_column'];?>" id="ihc_show_taxes_column" />
    </div>
  </div>
<?php endif; ?>
  <?php

		...
		switch ( $_POST['status'] ){
				...
				case 'Completed':
			        ...
			        $orderMeta = new \Indeed\Ihc\Db\OrderMeta();
							...
							$orderMeta->save( esc_sql( $_POST['id'] ), 'transaction_id', $transactionId );
								...
								case 'authorize':
									if ( $subscriptionId != '' ){
										if ( get_option( 'ihc_authorize_sandbox' ) == 1){
											...
											$chargingPlan = 'https://authorize.net/ui/themes/ARB/SubscriptionDetail.aspx?SubscrID=' . $subscriptionId;
										}
									}
								break;
						}

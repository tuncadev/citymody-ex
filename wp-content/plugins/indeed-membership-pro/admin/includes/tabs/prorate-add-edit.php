<?php
$groupId = isset( $_GET['id'] ) ? $_GET['id'] : false;
	...
	<div class="ihc-stuffbox">
				...
				<div class="row">
					<div class="col-xs-6">
						 <div class="input-group">
							...
							<input type="text" name="name" value="<?php if ( isset( $groupData['name'] ) ) echo $groupData['name'];?>" class="form-control" />
							</div>
					</div>
				</div>
			</div>
      ...
      <div class="iump-form-line">
          <h2><?php esc_html_e( 'Memberships on this Prorate Group', 'ihc' );?></h2>
			...
			<div class="iump-form-line">
	      <div class="ihc-prorate-memberships-groups" data-count="<?php echo $i;?>" >
	          <?php if ( $groupData ):?>
	          ...
	          <?php else : ?>
	              <div class="ihc-sortable-item ihc-prorate-group-item" id="<?php echo 'ihc_prorate_membership_no_1';?>">
	                  ...
	                  <select class="ihc-prorate-memberhip-item-select" name="memberships[]">
	                    <option></option>
	                    <?php foreach ( $memberships as $membershipData ): ?>
	                      <option value="<?php echo $membershipData['id'];?>"><?php echo $membershipData['label'];?></option>
	                    <?php endforeach;?>
	                  </select>
										<span class="ihc-js-prorate-remove-entry"><i class="fa-ihc fa-remove-ihc"></i></span>
	              </div>

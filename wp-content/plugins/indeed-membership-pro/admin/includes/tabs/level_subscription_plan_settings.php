				...
				<div class="inside">
					<div class="iump-form-line">
						...
						<div>
							<label class="iump_label_shiwtch ihc-switch-button-margin">
								...
								<input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '<?php echo '#ihc_level_subscription_plan_settings_restr_levels'.$id;?>');" <?php echo $checked;?> />
								<div class="switch ihc-display-inline"></div>
							</label>
					...
					<div class="iump-form-line">
						...
						<div>
							...
							<input type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, 'unreg', '<?php echo '#level' . $id . 'cond';?>');" /><span> <?php esc_html_e('UnRegistered Users', 'ihc');?></span>
						</div>
						<div>
							<?php $checked = (in_array('no_pay', $hidden_arr)) ? 'checked' : '';?>
							<input type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, 'no_pay', '<?php echo '#level' . $id . 'cond';?>');" /><span> <?php esc_html_e('Registered Users with no payment made', 'ihc');?></span>
						</div>
						...
						<?php foreach ($levels as $lid=>$larr):?>
							...
							<div class="ihc-list-access-posts-memberships">
								...
								<input class="form-check-input" type="checkbox" <?php echo $checked;?> onClick="ihcMakeInputhString(this, '<?php echo $lid;?>', '<?php echo '#level' . $id . 'cond';?>');" /> <span  class="form-check-label <?php echo $spanclass;?>"><?php echo $larr['label'];?></span>
							</div>
						<?php endforeach;?>

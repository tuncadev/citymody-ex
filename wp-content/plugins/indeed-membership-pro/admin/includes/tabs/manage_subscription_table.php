<?php
if ( isset($_POST['ihc_save'] ) && !empty($_POST['ihc_manage_subscription_table_nonce']) && wp_verify_nonce( $_POST['ihc_manage_subscription_table_nonce'], 'ihc_manage_subscription_table_nonce' ) ){
              ...
              <div class="iump-form-line iump-no-border">
                ...
                <div>
                  <label class="iump_label_shiwtch ihc-switch-button-margin">
                    ...
                    <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_plan_details_column');" <?php echo $checked;?> />
                    <div class="switch ihc-display-inline"></div>
                  </label>
                  <input type="hidden" name="ihc_show_plan_details_column" value="<?php echo $data['metas']['ihc_show_plan_details_column'];?>" id="ihc_show_plan_details_column" />
                </div>
              </div>
            </th>
              ...
              <div class="iump-form-line iump-no-border">
                ...
                <div>
                  <label class="iump_label_shiwtch ihc-switch-button-margin">
                    ...
                    <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_amount_column');" <?php echo $checked;?> />
                    <div class="switch ihc-display-inline"></div>
                  </label>
                  <input type="hidden" name="ihc_show_amount_column" value="<?php echo $data['metas']['ihc_show_amount_column'];?>" id="ihc_show_amount_column" />
                </div>
              </div>
            </th>
              ...
              <div class="iump-form-line iump-no-border">
                ...
                <div>
                  <label class="iump_label_shiwtch ihc-switch-button-margin">
                    ...
                    <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_payment_service_column');" <?php echo $checked;?> />
                    <div class="switch ihc-display-inline"></div>
                  </label>
                  <input type="hidden" name="ihc_show_payment_service_column" value="<?php echo $data['metas']['ihc_show_payment_service_column'];?>" id="ihc_show_payment_service_column" />
                </div>
              </div>
            </th>
              ...
              <div class="iump-form-line iump-no-border">
                ...
                <div>
                  <label class="iump_label_shiwtch ihc-switch-button-margin">
                    ...
                    <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_trial_period_column');" <?php echo $checked;?> />
                    <div class="switch ihc-display-inline"></div>
                  </label>
                  <input type="hidden" name="ihc_show_trial_period_column" value="<?php echo $data['metas']['ihc_show_trial_period_column'];?>" id="ihc_show_trial_period_column" />
                </div>
              </div>
            </th>
              ...
              <div class="iump-form-line iump-no-border">
                ...
                <div>
                  <label class="iump_label_shiwtch ihc-switch-button-margin">
                    ...
                    <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_grace_period_column');" <?php echo $checked;?> />
                    <div class="switch ihc-display-inline"></div>
                  </label>
                  <input type="hidden" name="ihc_show_grace_period_column" value="<?php echo $data['metas']['ihc_show_grace_period_column'];?>" id="ihc_show_grace_period_column" />
                </div>
              </div>
            </th>
              ...
              <div class="iump-form-line iump-no-border">
                ...
                <div>
                  <label class="iump_label_shiwtch ihc-switch-button-margin">
                    ...
                    <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_starts_on_column');" <?php echo $checked;?> />
                    <div class="switch ihc-display-inline"></div>
                  </label>
                  <input type="hidden" name="ihc_show_starts_on_column" value="<?php echo $data['metas']['ihc_show_starts_on_column'];?>" id="ihc_show_starts_on_column" />
                </div>
              </div>
            </th>
              ...
              <div class="iump-form-line iump-no-border">
                ...
                <div>
                  <label class="iump_label_shiwtch ihc-switch-button-margin">
                    ...
                    <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_expires_on_column');" <?php echo $checked;?> />
                    <div class="switch ihc-display-inline"></div>
                  </label>
                  <input type="hidden" name="ihc_show_expires_on_column" value="<?php echo $data['metas']['ihc_show_expires_on_column'];?>" id="ihc_show_expires_on_column" />
                </div>
              </div>
            </th>
              ...
              <div class="iump-form-line iump-no-border">
                ...
                <div>
                  <label class="iump_label_shiwtch ihc-switch-button-margin">
                    ...
                    <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_status_column');" <?php echo $checked;?> />
                    <div class="switch ihc-display-inline"></div>
                  </label>
                  <input type="hidden" name="ihc_show_status_column" value="<?php echo $data['metas']['ihc_show_status_column'];?>" id="ihc_show_status_column" />
                </div>
              </div>
            </th>
          </tr>
    ...
    <div class="iump-form-line">
      ...
      <div>
        <label class="iump_label_shiwtch ihc-switch-button-margin">
          ...
          <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_finish_payment');" <?php echo $checked;?> />
          <div class="switch ihc-display-inline"></div>
        </label>
        <input type="hidden" name="ihc_show_finish_payment" value="<?php echo $data['metas']['ihc_show_finish_payment'];?>" id="ihc_show_finish_payment" />
      </div>
        <div class="row">
          <div class="col-xs-6">
      ...
      <div class="row">
        <div class="col-xs-3">
          <div class="input-group">
            <input type="number" min="0" max="24" value="<?php echo $data['metas']['ihc_subscription_table_finish_payment_after'];?>" name="ihc_subscription_table_finish_payment_after" step="1" class="form-control">
      ...
      <div class="row">
        ...
        <div>
          <label class="iump_label_shiwtch ihc-switch-button-margin">
            ...
            <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_renew_link');" <?php echo $checked;?> />
            <div class="switch ihc-display-inline"></div>
          </label>
      ...
      <div class="iump-form-line">
        ...
        <div>
          <label class="iump_label_shiwtch ihc-switch-button-margin">
            ...
            <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_pause_resume_link');" <?php echo $checked;?> />
            <div class="switch ihc-display-inline"></div>
          </label>
          <input type="hidden" name="ihc_show_pause_resume_link" value="<?php echo $data['metas']['ihc_show_pause_resume_link'];?>" id="ihc_show_pause_resume_link" />
        </div>
      </div>
      ...
      <div class="iump-form-line">
        ...
        <div>
          <label class="iump_label_shiwtch ihc-switch-button-margin">
            ...
            <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_cancel_link');" <?php echo $checked;?> />
            <div class="switch ihc-display-inline"></div>
          </label>
          <input type="hidden" name="ihc_show_cancel_link" value="<?php echo $data['metas']['ihc_show_cancel_link'];?>" id="ihc_show_cancel_link" />
        </div>
      </div>
      ...
      <div class="iump-form-line">
        ...
        <div>
          <label class="iump_label_shiwtch ihc-switch-button-margin">
            ...
            <input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_show_delete_link');" <?php echo $checked;?> />
            <div class="switch ihc-display-inline"></div>
          </label>

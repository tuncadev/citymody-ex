		...
		<div class="inside">
			...
			<div class="iump-form-line">
				...
				<label class="iump_label_shiwtch ihc-switch-button-margin">
					...
					<input type="checkbox" class="iump-switch" onClick="iumpCheckAndH(this, '#ihc_cheat_off_enable');" <?php echo $checked;?> />
			...
			<div class="iump-form-line">
				...
				<input type="number" name="ihc_cheat_off_cookie_time" value="<?php echo $data['metas']['ihc_cheat_off_cookie_time'];?>" min="1"  /> <?php esc_html_e('Days', 'ihc');?>
			</div>
				...
				<select name="ihc_cheat_off_redirect">
					...
					<?php
						if ($pages){
							...
							?>
								<option value="<?php echo $k;?>" <?php if($data['metas']['ihc_cheat_off_redirect']==$k){
									echo 'selected';
								}
								?> ><?php echo $v;?></option>
							<?php

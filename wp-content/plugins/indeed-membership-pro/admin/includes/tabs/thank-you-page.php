...
if ( isset($_POST['ihc_save'] ) && !empty($_POST['ihc_admin_thank_you_settings_nonce']) && wp_verify_nonce( $_POST['ihc_admin_thank_you_settings_nonce'], 'ihc_admin_thank_you_settings_nonce' ) ){

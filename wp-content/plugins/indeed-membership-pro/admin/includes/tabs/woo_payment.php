		...
		<?php if (!empty($data['items'])):?>
			<div class="ihc-stuffbox">
				<table class="wp-list-table widefat fixed tags ihc-no-margin">
					...
					<tr>
						<td><span  class="ihc-list-affiliates-name-label"><a href="<?php echo admin_url('admin.php?page=ihc_manage&tab=levels&edit_level=' . $array['level_id']);?>" target="_blank"><?php echo $array['level_label'];?></a></span></td>

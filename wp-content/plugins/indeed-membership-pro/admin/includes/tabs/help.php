			...
			<form method="post" >
				<div class="inside">
					...
					<div class="iump-form-line iump-no-border ihc-help-settings-licensefield">
						<input name="pv2" type="password" value="<?php echo $h;?>"/>
					</div>

					<div class="ihc-stuffbox-submit-wrap iump-submit-form ihc-help-settings-licensebutton">
						<?php if ( $umpIsNotRegistered === '1' ): ?>
								<input type="submit" value="<?php esc_html_e('Register License', 'ihc');?>" name="ihc_save_licensing_code" <?php echo $disabled;?> class="button button-primary button-large" />
						<?php else :?>
								<?php if ( $e ):?>
				            <div class="ihc-revoke-license ihc-js-revoke-license"><?php esc_html_e( 'Revoke License', 'ihc' );?></div>
				        <?php else: ?>
										<input type="submit" value="<?php esc_html_e('Activate License', 'ihc');?>" name="ihc_save_licensing_code" <?php echo $disabled;?> class="button button-primary button-large" />
				        <?php endif;?>
						<?php endif;?>
					</div>

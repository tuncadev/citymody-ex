...
<div id="ihc_drip_content_meta_box" class="<?php echo $show_options;?>">
				...
				<div>
						...
						<div  class="ihc-inside-bootstrap-slide" id="ihc_slide_2" >
								...
								<div class="js-ump-select-drip-content-start-time-after-subscription ihc-inside-bootstrap-slide-div-2 <?php echo ( $meta_arr['ihc_drip_start_type'] != 2) ? 'ihc-display-none': ''; ?>"  >
										...
										<div>
												<input type="number" min="0" value="<?php echo $meta_arr['ihc_drip_start_numeric_value'];?>" name="ihc_drip_start_numeric_value" class="ihc_drip_start_numeric_value" />
												<select name="ihc_drip_start_numeric_type"><?php
														foreach (array('days'=>'Days', 'weeks'=>'Weeks', 'months'=>'Months') as $k=>$v){
														?>
																<option value="<?php echo $k;?>" <?php echo ($meta_arr['ihc_drip_start_numeric_type']==$k) ? 'selected' : ''; ?> ><?php echo $v;?></option>
														<?php
														}
												?></select>
										</div>
			...
			<div>
				...
				<div class="ihc-inside-bootstrap-slide" id="ihc_slide_3" >
					...
					<div class="js-ump-select-drip-content-end-time-after-subscription <?php echo ( $meta_arr['ihc_drip_end_type'] != 2) ? 'ihc-display-none': ''; ?>" >
							...
							<div>
									<input type="number" min="0" value="<?php echo $meta_arr['ihc_drip_end_numeric_value'];?>" name="ihc_drip_end_numeric_value" class="ihc_drip_start_numeric_value" />
									<select name="ihc_drip_end_numeric_type"><?php
										foreach (array('days'=>'Days', 'weeks'=>'Weeks', 'months'=>'Months') as $k=>$v){
											?>
											<option value="<?php echo $k;?>" <?php echo ($meta_arr['ihc_drip_end_numeric_type']==$k) ? 'selected' : ''; ?> ><?php echo $v;?></option>
											<?php
										}
									?></select>
							</div>
...
<div id="ihc_drip_content_empty_meta_box" class="<?php echo $show_not_available;?>">

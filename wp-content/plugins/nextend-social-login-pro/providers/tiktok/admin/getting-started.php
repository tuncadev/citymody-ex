    ...
    <?php else: ?>
        <div class="nsl-admin-getting-started">
            ...
            <ol>
                ...
                <li><?php printf(__('Enter your domain name into the %1$s field, probably: %2$s', 'nextend-facebook-connect'), '<strong>Redirect domain</strong>', '<strong>' . $_SERVER['HTTP_HOST'] . '</strong>'); ?></li>

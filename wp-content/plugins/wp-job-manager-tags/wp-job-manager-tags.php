...
class WP_Job_Manager_Job_Tags {
	...
	public function __construct() {
		define( 'JOB_MANAGER_TAGS_VERSION', '1.4.2' );
	...
	public function frontend_scripts() {
		wp_enqueue_style( 'wp-job-manager-tags-frontend', JOB_MANAGER_TAGS_PLUGIN_URL . '/assets/dist/css/frontend.css', [], JOB_MANAGER_TAGS_VERSION );
	}

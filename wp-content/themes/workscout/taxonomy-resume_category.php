			...
			if(empty($search_in_sb)) {
				...
				<form class="list-search"  method="GET" action="">
					<div class="search_keywords">
						...
						<input type="text" name="search_keywords" id="search_keywords" placeholder="<?php esc_attr_e( 'Search freelancer services (e.g. logo design)', 'workscout' ); ?>" value="<?php echo stripslashes(esc_attr( $keywords )); ?>" />

...
<div class="filters-container">
	...
	<div class="filters-flexbox-row">
		...
		<div class="filters-flexbox-child flex-one-half resume-filters-location">
			<?php  if (  class_exists('Astoundify_Job_Manager_Regions') &&  get_option( 'resume_manager_enable_regions_filter' ) || is_tax( 'job_listing_region' ) ) {  
				get_template_part('search-fields/split','resume-region'); 
			} else {

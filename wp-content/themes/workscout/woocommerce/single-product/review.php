...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		...
		<div class="comment-content"><div class="arrow-comment"></div>
			<div class="comment-by"><strong><?php comment_author(); ?></strong><span class="date"><time datetime="<?php echo get_comment_date( 'c' ); ?>"><?php echo get_comment_date( __( get_option( 'date_format' ), 'workscout' ) ); ?></time></span>
<?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) :
		$avclass = workscout_get_rating_class($rating); ?>
		<div  class="star-rating" title="<?php echo sprintf( esc_html__( 'Rated %d out of 5', 'workscout' ), $rating ) ?>">

...
function workscout_license_admin_notice(){
            ...
            if(!WorkScoutBase::CheckWPPlugin( $licenseKey, $liceEmail, $licenseMessage, $responseObj, $templateDir."/style.css")){            
            ob_start();

            ?>
                <div class="license-validation-popup">
                    <p>Oops, seems that you have not activated your WorkScout license yet!</p>
                    <a href="<?php echo add_query_arg( array( 'tab' => 'license' ) , menu_page_url('workscout_license',false) ) ?>" class="nav-tab">Activate License</a>
                </div>

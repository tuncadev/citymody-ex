...
class WorkScout_WP_Job_Manager_Colors {
	...
	function colorpicker_enqueue( $taxonomy ) {
	    ...
	    // Colorpicker Scripts
	//    wp_enqueue_script( 'wp-color-picker','', array('jquery'), null, true );
		wp_enqueue_script('workscout.jobtypes.color',get_template_directory_uri() . '/js/workscout.jobtypes.color.js', array('wp-color-picker'), false, true);
